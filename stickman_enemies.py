...
class Door(pygame.sprite.Sprite):
  ...
  def __init__(self, x, y):
    ...
    # Make a wall, of the size specified in the parameters
    self.image = pygame.image.load("castledoors.png").convert()
...
yay = pygame.mixer.Sound("magical_1.ogg")
...
block.change_x = random.randrange(-3,1)
block.change_y = random.randrange(-3,1)
block.left_boundary = 5
block.top_boundary = 5
block.right_boundary = WIDTH - 5
block.bottom_boundary = HT - 5

block2 = Walker2(BLACK, x_coord, y_coord, 24, 38)
block2.rect.x = random.randrange(WIDTH)
block2.rect.y = random.randrange(HT)

block2.change_x = random.randrange(-3,3)
block2.change_y = random.randrange(-3,3)
block2.left_boundary = 5
block2.top_boundary = 5
block2.right_boundary = WIDTH - 5
block2.bottom_boundary = HT - 5

# Add the block to the list of objects
block_list.add(block, block2)
all_sprite_list.add(block, block2)

font = pygame.font.Font(
    None, 50)  #can change fontname ->e.g."C:/Windows/FontDir/SHLBKB.TTF"
bg = pygame.image.load("GreyBrick.jpg")#.convert()
